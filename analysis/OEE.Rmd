...
Let's start by exploring the effect of filter length and population size. We're going to look at this in the empty environment, because we know the empty environment should always have change of 1.
